...
IMPLICIT NONE
INTEGER(KIND=C_INT), INTENT(IN) :: KONOFF
INTEGER(KIND=C_INT), INTENT(OUT) :: KRET
KRET = 0
IF (OML_DEBUG) KRET = 1
IF (KONOFF == 0) THEN 
  OML_DEBUG = .FALSE.
...
IMPLICIT NONE
INTEGER(KIND=C_INT), INTENT(OUT) :: KISSET
INTEGER(KIND=OML_LOCK_KIND), INTENT(INOUT) :: KMYLOCK
KISSET = 1
...
IMPLICIT NONE
INTEGER(KIND=C_INT), INTENT(OUT) :: KISPAR_REGION
KISPAR_REGION = 0
...
IMPLICIT NONE
INTEGER(KIND=C_INT), INTENT(OUT) :: KTIDS
...
IMPLICIT NONE
INTEGER(KIND=C_INT), INTENT(OUT) :: KMYTID
