...
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT_KEYSORT_1D',0,ZHOOK_HANDLE)
rc = 0
if (n <= 0) goto 99
if (size(a) <= 0) goto 99
aa(:,1) = a(:)
...
a(:) = aa(:,1)
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT_KEYSORT_1D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ikey
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT8_KEYSORT_1D',0,ZHOOK_HANDLE)
rc = 0
if (n <= 0) goto 99
if (size(a) <= 0) goto 99
aa(:,1) = a(:)
...
a(:) = aa(:,1)
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT8_KEYSORT_1D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ikey
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL4_KEYSORT_1D',0,ZHOOK_HANDLE)
rc = 0
if (n <= 0) goto 99
if (size(a) <= 0) goto 99
aa(:,1) = a(:)
...
a(:) = aa(:,1)
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL4_KEYSORT_1D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ikey
REAL(KIND=JPRB) :: ZHOOK_HANDLE
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL8_KEYSORT_1D',0,ZHOOK_HANDLE)
rc = 0
if (n <= 0) goto 99
if (size(a) <= 0) goto 99
aa(:,1) = a(:)
...
a(:) = aa(:,1)
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL8_KEYSORT_1D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ITID
ITID = OML_MY_THREAD()
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT_KEYSORT_2D',0,ZHOOK_HANDLE)
...
if (.not.present(index)) then
 ...
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT_KEYSORT_2D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ITID
ITID = OML_MY_THREAD()
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT8_KEYSORT_2D',0,ZHOOK_HANDLE)
...
if (.not.present(index)) then
 ...
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:INT8_KEYSORT_2D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ITID
ITID = OML_MY_THREAD()
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL4_KEYSORT_2D',0,ZHOOK_HANDLE)
...
if (.not.present(index)) then
 ...
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL4_KEYSORT_2D',1,ZHOOK_HANDLE)
...
INTEGER(KIND=JPIM) :: ITID
ITID = OML_MY_THREAD()
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL8_KEYSORT_2D',0,ZHOOK_HANDLE)
...
if (.not.present(index)) then
 ...
 99   continue
IF (LHOOK) CALL DR_HOOK('ECSORT_MIX:REAL8_KEYSORT_2D',1,ZHOOK_HANDLE)
