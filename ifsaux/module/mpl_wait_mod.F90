...
IF(PRESENT(KOUNT))THEN
  ...
  ENDIF
  DO JL=1,IREQLEN
    CALL MPI_GET_COUNT(IWAIT_STATUS(1,JL),MPI_REAL4,KOUNT(JL),ICOUNTERR)
  ENDDO
ENDIF
...
IF(PRESENT(KOUNT))THEN
  CALL MPI_GET_COUNT(IWAIT_STATUS(1,1),MPI_REAL4,KOUNT,ICOUNTERR)
ENDIF
...
IF(PRESENT(KOUNT))THEN
  ...
  ENDIF
  DO JL=1,IREQLEN
    CALL MPI_GET_COUNT(IWAIT_STATUS(1,JL),MPI_REAL8,KOUNT(JL),ICOUNTERR)
  ENDDO
ENDIF
...
IF(PRESENT(KOUNT))THEN
  CALL MPI_GET_COUNT(IWAIT_STATUS(1,1),MPI_REAL8,KOUNT,ICOUNTERR)
ENDIF
...
IF(PRESENT(KOUNT))THEN
  ...
  ENDIF
  DO JL=1,IREQLEN
    CALL MPI_GET_COUNT(IWAIT_STATUS(1,JL),MPI_INTEGER,KOUNT(JL),ICOUNTERR)
  ENDDO
ENDIF
...
IF(PRESENT(KOUNT))THEN
  CALL MPI_GET_COUNT(IWAIT_STATUS(1,1),MPI_INTEGER,KOUNT,ICOUNTERR)
ENDIF
