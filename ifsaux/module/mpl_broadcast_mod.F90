...
DO JCOL=1,ICOLS
  CALL MPL_BROADCAST(PBUF(1:IROWS,JCOL),KTAG,KROOT,KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
ENDDO
...
DO JCOL=1,ICOLS
  CALL MPL_BROADCAST(KBUF(1:IROWS,JCOL),KTAG,KROOT,KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
ENDDO
