...
ELSE
  ...
  IF(IPL_NUMPROC > 1) THEN
    CALL MPI_ALLGATHERV(PSENDBUF(1),ISENDCOUNT,MPI_REAL4,PRECVBUF(1),&
...
ELSE
  IF(IPL_NUMPROC > 1) THEN
    CALL MPI_ALLGATHERV(PSENDBUF(1),ISENDCOUNT,MPI_REAL8,PRECVBUF(1),&
...
ELSE
  IF(IPL_NUMPROC > 1) THEN
    CALL MPI_ALLGATHERV(KSENDBUF(1),ISENDCOUNT,MPI_INTEGER,KRECVBUF(1),&
...
INTEGER_M :: IRECVCOUNTS(MPL_NUMPROC)
