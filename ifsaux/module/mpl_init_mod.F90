...
#ifndef MPI1
  CALL GET_ENVIRONMENT_VARIABLE('MPI_THREAD_SINGLE',CL_SET)
  IF (CL_SET == '1') THEN
     ! export MPI_THREAD_SINGLE=1 # will enforce non-thread safe MPI -- still MPI2 (or later)
