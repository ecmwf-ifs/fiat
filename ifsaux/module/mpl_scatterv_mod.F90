...
INTEGER_M :: ICOMM,IROOT,IPL_NUMPROC,IRECVCOUNT,ISENDBUFSIZE,IR,IPL_MYRANK
LOGICAL   :: LLABORT=.TRUE.
INTEGER_M :: IERROR,IDUM
REAL_B    :: ZDUM

INTERFACE MPL_SCATTERV
MODULE PROCEDURE MPL_SCATTERV_REAL8,MPL_SCATTERV_INTEGER
END INTERFACE
...
INTEGER_M,INTENT(IN) :: KSENDCOUNTS(:)
INTEGER_M,INTENT(IN),OPTIONAL :: KSENDDISPL(:)
INTEGER_M,INTENT(OUT) :: KISENDDISPL(:) 
...
INTEGER_M, INTENT(IN) :: KROOT
REAL_B, INTENT(IN),OPTIONAL  :: PSENDBUF(:)
INTEGER_M, INTENT(IN),OPTIONAL :: KSENDCOUNTS(:), KSENDDISPL(:)
INTEGER_M, INTENT(IN),OPTIONAL :: KCOMM
INTEGER_M,INTENT(OUT),OPTIONAL :: KERROR
CHARACTER*(*),INTENT(IN),OPTIONAL :: CDSTRING

INTEGER_M :: ISENDDISPL(MPL_NUMPROC)
...
ELSE
  CALL MPI_SCATTERV(ZDUM,1,1,MPI_REAL8, &
   & PRECVBUF,IRECVCOUNT,MPI_REAL8,IROOT-1,ICOMM,IERROR)
ENDIF  
...
INTEGER_M, INTENT(OUT) :: KRECVBUF(:)
INTEGER_M, INTENT(IN) :: KROOT
INTEGER_M, INTENT(IN),OPTIONAL :: KSENDBUF(:)
INTEGER_M, INTENT(IN),OPTIONAL :: KSENDCOUNTS(:), KSENDDISPL(:)
INTEGER_M, INTENT(IN),OPTIONAL :: KCOMM
INTEGER_M,INTENT(OUT),OPTIONAL :: KERROR
CHARACTER*(*),INTENT(IN),OPTIONAL :: CDSTRING
...
ELSE
  CALL MPI_SCATTERV(ZDUM,1,1,MPI_INTEGER, &
   & KRECVBUF,IRECVCOUNT,MPI_INTEGER,IROOT-1,ICOMM,IERROR)
ENDIF  
