...
INTEGER_M :: ICOMM,IERROR,IPL_NUMPROC,IRECVCOUNT,ISENDCOUNT,IR
LOGICAL :: LLSCALAR
...
INTEGER_M,INTENT(IN) :: KRECVCOUNTS(:),KSENDCOUNTS(:)
INTEGER_M,INTENT(OUT) :: KISENDDISPL(:),KIRECVDISPL(:)
INTEGER_M,INTENT(IN),OPTIONAL :: KSENDDISPL(:),KRECVDISPL(:),KCOMM
...
IMPLICIT NONE
INTEGER_M, INTENT(IN) :: KSENDCOUNTS(:), KRECVCOUNTS(:)
...
INTEGER_M :: IRECVDISPL(MPL_NUMPROC),ISENDDISPL(MPL_NUMPROC)
...
CALL MPI_ALLTOALLV(PSENDBUF(1),KSENDCOUNTS,ISENDDISPL,MPI_REAL8, &
                 & PRECVBUF(1),KRECVCOUNTS,IRECVDISPL,MPI_REAL8,ICOMM,IERROR)
