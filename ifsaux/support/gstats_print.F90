    ...
    IF( LDETAILED_STATS .OR. JROC==1) THEN
      ...
      IF(LSTATS_COMMS.AND.LSTATS_OMP)THEN
        WRITE(KULOUT,'(A,F8.2)')'FRACTION OF TOTAL TIME ACCOUNTED FOR ',&
         & (ZT_SUM+ZT_SUM2+ZT_SUM3)/TIMESUM(0)*100.0_JPRB
      ENDIF
    ENDIF
  ENDDO
  WRITE(KULOUT,*) ''
