...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_READ(KFILE,KBUF,KBYTES,IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_READ(KFILE,PBUF,KBYTES,IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS .AND. IRET < JPBYTES_IO_END_OF_FILE ) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_READ(KFILE,CDBUF,KBYTES,IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS .AND. IRET < JPBYTES_IO_END_OF_FILE ) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_WRITE(KFILE,PBUF,KBYTES,IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ENDIF
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_WRITE(KFILE,CDBUF,KBYTES,IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_READ(KFILE,KBUF,INT(KBYTES,JPIM),IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS .AND. IRET < JPBYTES_IO_END_OF_FILE ) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_READ(KFILE,PBUF,INT(KBYTES,JPIM),IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS .AND. IRET < JPBYTES_IO_END_OF_FILE ) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_READ(KFILE,CDBUF,INT(KBYTES,JPIM),IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS .AND. IRET < JPBYTES_IO_END_OF_FILE ) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_WRITE(KFILE,PBUF,INT(KBYTES,JPIM),IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ENDIF
IF(IRET < JPBYTES_IO_SUCCESS ) THEN
...
IRET = 0
IF(KBYTES > 0) CALL C_BYTES_IO_WRITE(KFILE,CDBUF,INT(KBYTES,JPIM),IRET)
IF(PRESENT(KRET)) THEN
  KRET=IRET
ELSEIF(IRET < JPBYTES_IO_SUCCESS) THEN
