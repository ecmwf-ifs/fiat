...
USE MPL_DATA_MODULE,          ONLY : MPL_RANK, MPL_COMM_OML, MPL_ERRUNIT, MPL_NUMPROC, MPL_METHOD, &
...
! ------------------------------------------------------------------
MODULE PROCEDURE MPL_SCATTERV_REAL8!(PRECVBUF,KROOT,PSENDBUF,KSENDCOUNTS,KSENDDISPL,&
...
#include "mpl_scatterv_realarray_tmpl.i90"

END PROCEDURE MPL_SCATTERV_REAL8
! ------------------------------------------------------------------
MODULE PROCEDURE MPL_SCATTERV_REAL4!(PRECVBUF,KROOT,PSENDBUF,KSENDCOUNTS,KSENDDISPL,&
!  &  KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
...
END PROCEDURE MPL_SCATTERV_REAL4


MODULE PROCEDURE MPL_SCATTERV_INTEGER!(KRECVBUF,KROOT,KSENDBUF,KSENDCOUNTS,&
...
#include "mpl_scatterv_integerarray_tmpl.i90"

END PROCEDURE MPL_SCATTERV_INTEGER
! ------------------------------------------------------------------
