...
USE MPL_DATA_MODULE, ONLY : MPL_NUMPROC, LINITMPI_VIA_MPL, MPL_ATTACHED_BUFFER, JP_ATTACHED_BUFFER_BYTES
USE MPL_MESSAGE_MOD, ONLY : MPL_MESSAGE
USE MPL_MPI,         ONLY : MPI_BUFFER_DETACH, MPI_FINALIZE, MPI_INITIALIZED, MPI_FINALIZED
