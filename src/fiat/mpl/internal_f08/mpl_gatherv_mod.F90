...
USE MPL_MPI,                  ONLY : MPI_COMM, MPI_DATATYPE, MPI_REQUEST, MPI_REAL4, MPI_REAL8, MPI_INTEGER, MPI_CHARACTER
...
IF (PRESENT(KRECVBUF)) THEN
ASSOCIATE(PSENDBUF=>KSENDBUF,PRECVBUF=>KRECVBUF)
#include "mpl_gatherv_array_tmpl.i90"
END ASSOCIATE
ELSE
ASSOCIATE(PSENDBUF=>KSENDBUF,PRECVBUF=>KSENDBUF)
#include "mpl_gatherv_array_tmpl.i90"
END ASSOCIATE
END IF
