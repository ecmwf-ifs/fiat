...
! ------------------------------------------------------------------
   ...
   USE MPL_MPI,                  ONLY : MPI_COMM, MPI_REQUEST, MPI_REAL4, MPI_REAL8, MPI_INTEGER, &
 &                                      MPI_ALLTOALLV, MPI_IALLTOALLV
   USE MPL_DATA_MODULE,          ONLY : MPL_COMM_OML, MPL_NUMPROC, MPL_ERRUNIT, MPL_METHOD, &
...
! ------------------------------------------------------------------
   ...
   MODULE PROCEDURE MPL_ALLTOALLV_REAL8!(PSENDBUF,KSENDCOUNTS,PRECVBUF,KRECVCOUNTS,&
...
!!      INTEGER(KIND=JPIM), INTENT(OUT),OPTIONAL :: KREQUEST,KERROR
   ...
   END PROCEDURE MPL_ALLTOALLV_REAL8

   MODULE PROCEDURE MPL_ALLTOALLV_REAL4!(PSENDBUF,KSENDCOUNTS,PRECVBUF,KRECVCOUNTS,&
!   &KSENDDISPL,KRECVDISPL,KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
...
!!      INTEGER(KIND=JPIM), INTENT(OUT),OPTIONAL :: KREQUEST,KERROR
   ...
   END PROCEDURE MPL_ALLTOALLV_REAL4


   MODULE PROCEDURE MPL_ALLTOALLV_INTEGER!(KSENDBUF,KSENDCOUNTS,KRECVBUF,KRECVCOUNTS,&
!   &KSENDDISPL,KRECVDISPL,KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
...
!!      INTEGER(KIND=JPIM), INTENT(OUT),OPTIONAL :: KREQUEST,KERROR
   ...
   END PROCEDURE MPL_ALLTOALLV_INTEGER
