...
! ------------------------------------------------------------------
 ...
 &                                      MPI_ALLTOALLV, MPI_IALLTOALLV, MPI_COMM_SIZE
...
! ------------------------------------------------------------------
   ...
   MODULE PROCEDURE MPL_ALLTOALLV_REAL8
   ...
   MODULE PROCEDURE MPL_ALLTOALLV_REAL4
   ...
   MODULE PROCEDURE MPL_ALLTOALLV_INTEGER
