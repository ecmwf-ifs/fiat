...
PRIVATE :: STATUS8
  INTEGER(KIND=JPIB), DIMENSION(MPI_STATUS_SIZE) :: STATUS8
...
SUBROUTINE MPI_BUFFER_DETACH8(BUFFER_ADDR, SZ, IERROR)
  ...
  INTEGER(KIND=JPIB), DIMENSION(:), ALLOCATABLE :: &
    BUFFER_ADDR8
  INTEGER(KIND=JPIB) :: &
    SZ8, IERROR8
...
SUBROUTINE MPI_CART_COORDS8(COMM, RANK, MAXDIMS, COORDS, IERROR)
  ...
  INTEGER(KIND=JPIB), DIMENSION(:), ALLOCATABLE :: COORDS8
  INTEGER(KIND=JPIB) :: &
...
SUBROUTINE MPI_CART_CREATE8(COMM_OLD, NDIMS, DIMS, PERIODS, REORDER, COMM_CART, IERROR)
  ...
  LOGICAL(KIND=JPIB), DIMENSION(:), ALLOCATABLE :: &
    PERIODS8
  LOGICAL(KIND=JPIB) :: &
    REORDER8
...
SUBROUTINE MPI_WAIT8_I4(REQUEST, STATUS, IERROR)
  ...
  INTEGER(KIND=JPIB) :: &
    REQUEST8, IERROR8
  INTEGER(KIND=JPIB), DIMENSION(:), ALLOCATABLE :: STATUS8
