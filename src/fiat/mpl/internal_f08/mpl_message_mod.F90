...
USE MPL_MPI,         ONLY : MPI_MAX_ERROR_STRING, MPI_ERROR_STRING
...
SUBROUTINE MPL_MESSAGE(CDMESSAGE,CDSTRING,KERROR,LDABORT)
...
CHARACTER(LEN=MPI_MAX_ERROR_STRING) :: CLMPI_ERROR
CHARACTER(LEN=12)                   :: CLERROR
