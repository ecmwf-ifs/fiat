...
USE MPL_MPI,  ONLY : MPI_COMM, MPI_COMM_NULL
...
INTERFACE MPL_COMM_FREE
  MODULE PROCEDURE MPL_COMM_FREE_INT, MPL_COMM_FREE_F08
END INTERFACE MPL_COMM_FREE

CONTAINS

SUBROUTINE MPL_COMM_FREE_INT (KCOMM, KERR, CDSTRING)
...
END SUBROUTINE MPL_COMM_FREE_INT

SUBROUTINE MPL_COMM_FREE_F08 (KCOMM, KERR, CDSTRING)
TYPE(MPI_COMM),    INTENT (INOUT) :: KCOMM
INTEGER (KIND=JPIM), INTENT (OUT) :: KERR
CHARACTER (LEN=*),   INTENT (IN), OPTIONAL :: CDSTRING
...
END SUBROUTINE MPL_COMM_FREE_F08
