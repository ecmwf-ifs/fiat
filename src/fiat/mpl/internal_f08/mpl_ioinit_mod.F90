...
USE MPL_MPI,         ONLY : MPI_COMM, MPI_UNDEFINED, MPI_COMM_SPLIT
USE MPL_DATA_MODULE, ONLY : MPL_RANK, MPL_COMM
...
TYPE(MPI_COMM)     :: MPL_COMM_IO_INTERNAL,MPL_COMM_INTERNAL 
...
CALL MPI_COMM_SPLIT(MPL_COMM_INTERNAL,COLOR,KEY,MPL_COMM_IO_INTERNAL,KERROR)

MPL_COMM=MPL_COMM_INTERNAL%MPI_VAL
MPL_COMM_IO=MPL_COMM_IO_INTERNAL%MPI_VAL
!
!
!     -----------------------------------------------------------------
RETURN
