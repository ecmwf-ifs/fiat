...
USE MPL_MPI,                  ONLY : MPI_COMM, MPI_DATATYPE, MPI_REQUEST, MPI_REAL4, MPI_REAL8, MPI_INTEGER, &
 &       MPI_CHARACTER, MPI_GATHERV, MPI_IGATHERV
...
MODULE PROCEDURE MPL_GATHERV_REAL4!(PSENDBUF,KROOT,PRECVBUF,KRECVCOUNTS,KSENDCOUNT,KRECVDISPL, &
...
MODULE PROCEDURE MPL_GATHERV_REAL8!(PSENDBUF,KROOT,PRECVBUF,KRECVCOUNTS,KSENDCOUNT,KRECVDISPL, &
!  & KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
...
MODULE PROCEDURE MPL_GATHERV_INT!(KSENDBUF,KROOT,KRECVBUF,KRECVCOUNTS,KSENDCOUNT,KRECVDISPL, &
!  &  KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
...
MODULE PROCEDURE MPL_GATHERV_CHAR_SCALAR!(CSENDBUF,KROOT,CRECVBUF,KRECVCOUNTS,KSENDCOUNT,KRECVDISPL, &
!  & KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
