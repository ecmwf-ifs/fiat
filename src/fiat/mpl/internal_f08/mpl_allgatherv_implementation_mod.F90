...
USE MPL_MPI,                  ONLY : MPI_REQUEST, MPI_COMM, MPI_REAL4, MPI_REAL8, MPI_INTEGER, &
 &                                   MPI_ALLGATHERV, MPI_IALLGATHERV, MPI_COMM_SIZE
...
MODULE PROCEDURE MPL_ALLGATHERV_REAL4
...
MODULE PROCEDURE MPL_ALLGATHERV_REAL8
...
MODULE PROCEDURE MPL_ALLGATHERV_INT
