...
SUBROUTINE MPL_GATHERV_INT(PSENDBUF,KROOT,PRECVBUF,KRECVCOUNTS,KSENDCOUNT,KRECVDISPL, &
  &  KMP_TYPE,KCOMM,KERROR,KREQUEST,CDSTRING)
...
INTEGER(KIND=JPIM),INTENT(IN),OPTIONAL :: KROOT
INTEGER(KIND=JPIM),INTENT(IN)         :: PSENDBUF(:)
INTEGER(KIND=JPIM),INTENT(OUT),OPTIONAL :: PRECVBUF(:)
