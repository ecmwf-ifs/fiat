...
IF(IPL_MYRANK == IROOT) THEN
  ...
  ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
    CALL MPI_IGATHERV(PSENDBUF,ISENDCOUNT,MPI_REAL4,PRECVBUF,KRECVCOUNTS, &
     &  IRECVDISPL,MPI_REAL4,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
...
ELSE
  IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
    CALL MPI_GATHERV(PSENDBUF,ISENDCOUNT,MPI_REAL4,ZDUM_JPRM,ONES, &
     &  ONES,MPI_REAL4,IROOT-1,ICOMM,IERROR)
  ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
    CALL MPI_IGATHERV(PSENDBUF,ISENDCOUNT,MPI_REAL4,ZDUM_JPRM,ONES, &
     &  ONES,MPI_REAL4,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
    KREQUEST=IREQUEST_LOCAL%MPI_VAL
  ENDIF
  IF(LMPLSTATS) THEN
    CALL MPL_SENDSTATS(ISENDCOUNT,MPI_REAL4%MPI_VAL)
...
IF(IPL_MYRANK == IROOT) THEN
  ...
  ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
    CALL MPI_IGATHERV(PSENDBUF,ISENDCOUNT,MPI_REAL8,PRECVBUF,KRECVCOUNTS,&
     &  IRECVDISPL,MPI_REAL8,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
    KREQUEST=IREQUEST_LOCAL%MPI_VAL
  ENDIF
  IF(LMPLSTATS) THEN
...
IF(IPL_MYRANK == IROOT) THEN
  ...
  IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
    CALL MPI_GATHERV(CSENDBUF,ISENDCOUNT,MPI_CHARACTER,CRECVBUF(1),KRECVCOUNTS,&
     &  IRECVDISPL,MPI_CHARACTER,IROOT-1,ICOMM,IERROR)
  ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
    CALL MPI_IGATHERV(CSENDBUF,ISENDCOUNT,MPI_CHARACTER,CRECVBUF(1),KRECVCOUNTS,&
     &  IRECVDISPL,MPI_CHARACTER,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
    KREQUEST=IREQUEST_LOCAL%MPI_VAL
  ENDIF
  IF(LMPLSTATS) THEN
...
ELSE
  IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
    CALL MPI_GATHERV(CSENDBUF,ISENDCOUNT,MPI_CHARACTER,crecvbuf(1),ONES, &
...
IF(IPL_MYRANK == IROOT) THEN
  ...
  ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
    CALL MPI_IGATHERV(KSENDBUF,ISENDCOUNT,MPI_INTEGER,KRECVBUF,&
     & KRECVCOUNTS,IRECVDISPL,MPI_INTEGER,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
    KREQUEST=IREQUEST_LOCAL%MPI_VAL
  ENDIF
  IF(LMPLSTATS) THEN
...
IF(IPL_MYRANK == IROOT) THEN
  ...
  IF(PRESENT(KRECVDISPL).OR.PRESENT(KSENDCOUNT)) THEN
    ...
    ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
      CALL MPI_IGATHERV(KSENDBUF,ISENDCOUNT,MPI_INTEGER,KRECVBUF,&
       & IRECVCOUNTS,IRECVDISPL,MPI_INTEGER,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
      KREQUEST=IREQUEST_LOCAL%MPI_VAL
    ENDIF
    IF(LMPLSTATS) THEN
      CALL MPL_SENDSTATS(ISENDCOUNT,MPI_INTEGER%MPI_VAL)
  ...
  IF(PRESENT(KRECVDISPL)) THEN
    ...
    ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
      CALL MPI_IGATHERV(PSENDBUF,ISENDCOUNT,MPI_REAL8,PRECVBUF,&
       & IRECVCOUNTS,IRECVDISPL,MPI_REAL8,IROOT-1,ICOMM,IREQUEST_LOCAL,IERROR)
      KREQUEST=IREQUEST_LOCAL%MPI_VAL
    ENDIF
    IF(LMPLSTATS) THEN
      CALL MPL_SENDSTATS(ISENDCOUNT,MPI_REAL8%MPI_VAL)
