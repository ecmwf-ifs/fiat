...
ELSE
  IF(PRESENT(KREQUEST)) THEN
     CALL DISPL_ARRAY_LIST%APPEND(NPROC=IPL_NUMPROC, RECV_PT=KIRECVDISPL_PT)
  ELSE
...
ELSE
   IF(PRESENT(KREQUEST)) THEN
     CALL DISPL_ARRAY_LIST%APPEND(NPROC=IPL_NUMPROC, SEND_PT = KISENDDISPL_PT, NO_NEW_NODE=.TRUE.)
  ELSE
