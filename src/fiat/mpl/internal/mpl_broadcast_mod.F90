...
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  ...
  CALL MPI_IBCAST(PBUF,ICOUNT,MPI_REAL4,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
...
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF,ICOUNT,MPI_REAL8,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(PBUF(1,1),ICOUNT,MPI_REAL4,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF(1,1),ICOUNT,MPI_REAL4,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(PBUF(1,1,1),ICOUNT,MPI_REAL4,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF(1,1,1),ICOUNT,MPI_REAL4,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(PBUF(1,1,1,1),ICOUNT,MPI_REAL4,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF(1,1,1,1),ICOUNT,MPI_REAL4,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(PBUF(1,1),ICOUNT,MPI_REAL8,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF(1,1),ICOUNT,MPI_REAL8,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(PBUF(1,1,1),ICOUNT,MPI_REAL8,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF(1,1,1),ICOUNT,MPI_REAL8,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(PBUF(1,1,1,1),ICOUNT,MPI_REAL8,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(PBUF(1,1,1,1),ICOUNT,MPI_REAL8,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(KBUF,ICOUNT,MPI_INTEGER,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(KBUF(1,1),ICOUNT,MPI_INTEGER,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(KBUF(1,1),ICOUNT,MPI_INTEGER,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
IF(IMP_TYPE == JP_BLOCKING_STANDARD .OR. IMP_TYPE == JP_BLOCKING_BUFFERED) THEN
  CALL MPI_BCAST(KBUF(1,1,1),ICOUNT,MPI_INTEGER,IROOT-1,ICOMM,IERROR)
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(KBUF(1,1,1),ICOUNT,MPI_INTEGER,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(CDBUF,ICOUNT,MPI_BYTE,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
...
ELSEIF(IMP_TYPE == JP_NON_BLOCKING_STANDARD .OR. IMP_TYPE == JP_NON_BLOCKING_BUFFERED) THEN
  IF(.NOT.PRESENT(KREQUEST)) CALL MPL_MESSAGE(CDMESSAGE='MPL_SEND',CDSTRING=' KREQUEST MISSING',KERROR=KERROR,LDABORT=LLABORT)
  CALL MPI_IBCAST(LDBUF,ICOUNT,MPI_LOGICAL,IROOT-1,ICOMM,KREQUEST_LOCAL,IERROR)
  KREQUEST=KREQUEST_LOCAL%MPI_VAL
ELSE
  IF(PRESENT(KERROR)) THEN
    IERROR=1
