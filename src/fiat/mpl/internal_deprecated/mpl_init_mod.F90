...
USE MPL_MPIF,              ONLY : MPI_THREAD_MULTIPLE, MPI_THREAD_SINGLE, MPI_INTEGER, MPI_BYTE, MPI_COMM_WORLD
USE MPL_DATA_MODULE,       ONLY : JP_BLOCKING_BUFFERED, JP_BLOCKING_STANDARD, &
 &                                LFULLNODES, LINITMPI_VIA_MPL, LINITMPL_ALLOCATOR_VIA_MPL, LMPLUSERCOMM, LTHSAFEMPI, &
 &                                LUSEHLMPI, MPL_COMM, &
 &                                MPL_COMM_OML, MPL_IDS, MPL_MAX_TASK_PER_NODE, MPL_MBX_SIZE, MPL_METHOD, MPL_MYNODE, &
 &                                MPL_NNODES, MPL_NCPU_PER_NODE, MPL_NODE, MPL_NODE_TASKS, MPL_NUMPROC, MPL_OPPONENT, &
 &                                MPL_OUTPUT, MPL_RANK, MPL_TASK_PER_NODE, MPLUSERCOMM, MPL_UNIT, MPL_WORLD_RANK, &
 &                                MPL_WORLD_SIZE
