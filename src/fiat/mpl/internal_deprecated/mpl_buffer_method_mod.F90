...
USE MPL_DATA_MODULE, ONLY : MPL_ATTACHED_BUFFER, MPL_IDS, MPL_MBX_SIZE, MPL_METHOD, MPL_NUMPROC, MPL_RANK, MPL_UNIT, &
 &                          JP_ATTACHED_BUFFER_BYTES, JP_BLOCKING_STANDARD, JP_BLOCKING_BUFFERED!, &
