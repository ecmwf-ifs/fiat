...
USE MPL_MPIF,          ONLY : MPI_INTEGER, MPI_INTEGER8, MPI_REAL4, MPI_REAL8, MPI_MIN, MPI_MAX, MPI_SUM, MPI_BXOR
USE MPL_DATA_MODULE,   ONLY : MPL_COMM_OML, MPL_ERRUNIT, MPL_NUMPROC, MPL_OUTPUT, MPL_RANK, MPL_UNIT, &
